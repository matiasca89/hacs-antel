...
class AntelScraper:
    ...
    async def _extract_consumption_data(self, page: Page) -> AntelConsumoData:
        ...
        try:
            # We skip networkidle and sleep(2) here because get_consumption_data
            # already waits for the essential selectors before calling extraction.
    ...
    async def get_consumption_data(self) -> AntelConsumoData:
        ...
        # Optimization: Block images, media and fonts to save bandwidth and speed up page load
        await context.route(
            "**/*",
