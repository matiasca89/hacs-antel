...
class AntelScraper:
    ...
    async def get_consumption_data(self) -> AntelConsumoData:
        ...
        try:
            ...
            # Navigate directly to internet consumption page (faster than clicking through menus)
            _LOGGER.debug("Navigating directly to internet consumption page")
            try:
